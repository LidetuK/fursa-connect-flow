        ...
        <Card className="bg-card border border-border/20 rounded-3xl shadow-lg">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" className="h-12 rounded-xl border-border/30">
        ...
        <Card className="bg-primary/5 border border-primary/20 rounded-2xl p-4">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Use <code className="bg-primary/20 px-2 py-1 rounded">demo@fursaai.com</code> and password <code className="bg-primary/20 px-2 py-1 rounded">demo123</code>
            </p>
          </div>
        </Card>
      </div>
